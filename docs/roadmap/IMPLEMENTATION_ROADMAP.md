...
- [x] Create `accounts-service/src/main/java/com/example/accountsservice/owner/infrastructure/client/dto/CustomerSummary.java`:
  ```java
...
- [x] Create `accounts-service/src/main/java/com/example/accountsservice/owner/infrastructure/client/CustomersClient.java`:
  ```java
...
- [x] Create `accounts-service/src/main/java/com/example/accountsservice/owner/api/dto/AccountOwnerResponse.java`:
  ```java
...
- [x] Create `accounts-service/src/main/java/com/example/accountsservice/owner/application/GetAccountOwnerUseCase.java`:
  ```java
...
- [x] Create `accounts-service/src/test/.../owner/application/GetAccountOwnerUseCaseTest.java`
...
### 3.1 — Add Zipkin to `platform/docker/docker-compose.yml`
...
- [ ] Start all services: `docker compose -f platform/docker/docker-compose.yml up -d`, then start all three Spring Boot apps.
...
- [x] Create `gateway-service/src/main/java/com/example/gatewayservice/security/SecurityConfig.java`:
  ```java
