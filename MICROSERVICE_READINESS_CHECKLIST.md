...
- ✅ **Clear bounded-context internals (DDD layering per service):** domain/application/infrastructure/interfaces.
...
- Reactive PostgreSQL adapters:
  - `customers-service/src/main/java/com/example/customersservice/infrastructure/repository/PostgresCustomerRepository.java`
  - `accounts-service/src/main/java/com/example/accountsservice/infrastructure/repository/PostgresAccountRepository.java`
- SQL initialization scripts:
  - `customers-service/src/main/resources/schema.sql`
  - `customers-service/src/main/resources/data.sql`
  - `accounts-service/src/main/resources/schema.sql`
  - `accounts-service/src/main/resources/data.sql`
